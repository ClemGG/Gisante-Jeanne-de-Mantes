...
public class GodMode : MonoBehaviour
{
    ...
    {
        transform.Translate(Vector3.forward * Input.GetAxis("Vertical") * vitesseDeplacement * Time.unscaledDeltaTime);
        transform.Translate(Vector3.right * Input.GetAxis("Horizontal") * vitesseDeplacement * Time.unscaledDeltaTime);
